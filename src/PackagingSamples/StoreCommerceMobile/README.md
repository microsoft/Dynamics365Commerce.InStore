...
#### Android
  ...
  - If you do not wish to develop an Android app, comment out the net9.0-android target framework in the mobile app project.

#### iOS
  - If you are developing on Windows, you need to pair a Mac for iOS development: https://learn.microsoft.com/en-us/dotnet/maui/ios/pair-to-mac?view=net-maui-9.0
  - If you do not wish to develop an iOS app, comment out the net9.0-ios target framework in the mobile app project.