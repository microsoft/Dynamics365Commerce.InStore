# Hardware Station Payment Device Sample
...
The implemented Request Handler includes the following list of Supported Requests:
 ...
 - Duplicate Payment Protection: Get Transaction Reference, Get Transaction by Transaction Reference
   Requests used to match the current active transaction reference and prevent duplicated payments from happening.
